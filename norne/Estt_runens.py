...
VALUES = [2e-1,2e-3,6e-3,8e-3, 0.009745246672547517,0.013018454378766364]
DEFAULTADAPTIVE = 0.013018454378766364
# VALUES = np.random.uniform(0.009,0.013018454378766364,10)
...
FLAGS = f" --relaxed-max-pv-fraction=0 --use-m-lmethods-tols=false --use-eisenstat=true --linear-solver-reduction=5e-3 --output-extra-convergence-info=steps,iterations --enable-ecl-output=0 --full-time-step-initially=1  --tolerance-cnv-relaxed=1e-2 --tolerance-cnv=1e-2 --tolerance-mb=1e-5 --tolerance-mb-relaxed=1e-5 "
FLAGSADAPT = f" --relaxed-max-pv-fraction=0  --use-m-lmethods-tols=true --use-eisenstat=true --linear-solver-reduction=5e-3 --output-extra-convergence-info=steps,iterations --enable-ecl-output=0 --full-time-step-initially=1  --tolerance-cnv-relaxed=1e-2 --tolerance-cnv=1e-2 --tolerance-mb=1e-5 --tolerance-mb-relaxed=1e-5 "
