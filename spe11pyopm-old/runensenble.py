...
VALUES = [1e-8,5e-8,1e-7,5e-7, 1e-6,5e-6,1e-5,5e-5,1e-4,5e-4,1e-3,5e-3, 7.5e-3,1e-2]
DEFAULTADAPTIVE = 5e-3
# VALUES = np.random.uniform(1e-4,1e-3,7)
...
FLAGS = f" --use-best-residual=true --relaxed-max-pv-fraction=0 --output-extra-convergence-info=steps,iterations --enable-ecl-output=0 --full-time-step-initially=1  --tolerance-cnv-relaxed=1e-2 --tolerance-cnv=1e-2 --tolerance-mb=1e-5 --tolerance-mb-relaxed=1e-5 --newton-min-iterations=1 --newton-max-iterations={NEWTONMAXIT} "
FLAGSADAPT = f"  --use-m-lmethods-tols=true --use-best-residual=true  --relaxed-max-pv-fraction=0 --output-extra-convergence-info=steps,iterations --enable-ecl-output=0 --full-time-step-initially=1  --tolerance-cnv-relaxed=1e-2 --tolerance-cnv=1e-2 --tolerance-mb=1e-5 --tolerance-mb-relaxed=1e-5 --newton-min-iterations=1 --newton-max-iterations={NEWTONMAXIT} "
