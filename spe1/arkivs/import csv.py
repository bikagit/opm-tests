...
orikrnw, orikrw, oriSandSmax = PreprocessData(SS, '/data/arkivdata/KrPcData_Swi0_06.csv', "GW")
orikrnw1, orikrw1, oriSandSmax1 = PreprocessData(SS, '/data/arkivdata/KrPcData_Swi0_06-CORRECTED.csv', "GW")
