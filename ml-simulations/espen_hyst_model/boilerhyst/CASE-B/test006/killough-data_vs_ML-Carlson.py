...
def trainNN(krnw, Smax):
    ...
    early_stopping = EarlyStopping(monitor='val_loss', patience=50, restore_best_weights=True, start_from_epoch=100)
...
newtrain_file = '/../../../../../spe1/swat_oilkr3.csv'



newkrnw, newkrw, newSandSmax = newPreprocessData(SSI, newtrain_file,"/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test006/CORE_ExampleCarlson", "WO")
...
krnw_modl, krw_modl, SandSmax_modl = Preprocess_analytical_Model_Data(SSI, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test006/CORE_ExampleCarlson", "WO")


modelnonwett, history, X_test, y_test, x_val, y_val = trainNN(newkrnw, newSandSmax)


export_model(modelnonwett, 'model/oldmodelkrnwCORE_ExampleCarlson.model')
...
for valsatmax in {0.25,0.3,0.35, 0.4, 0.5}:
    ...
    if x_vals and y_vals:
        plt.plot(x_vals, y_vals, color='black', marker="*", label="ML-Carlson Imbib. scan curves" if valsatmax == 0.25 else "")
...
evaluate(maincurves0, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test006/CORE_ExampleCarlson", "WO",labelfig="Primary drainage")
evaluate(maincurves1, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test006/CORE_ExampleCarlson", "WO",labelfig="First imbibition")

evaluate(SatSpace, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test006/CORE_ExampleCarlson", "WO",labelfig="Imbib. Carlson scan curve")
...
plt.tight_layout()
plt.savefig("output_figures/final_model_plots_with_comparisonCarlson.png")
