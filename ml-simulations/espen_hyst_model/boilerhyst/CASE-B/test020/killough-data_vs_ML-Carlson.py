...
def trainNN(krnw, Smax):
    ...
    model = create_model(X_train.shape[1], 5, [30]*5, Adam(learning_rate=0.01))
...
newtrain_file = '/runCarlson.csv'



newkrnw, newkrw, newSandSmax = newPreprocessData(SSI, newtrain_file,"/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test020/CORE_ExampleCarlson", "WO")
...
krnw_modl, krw_modl, SandSmax_modl = Preprocess_analytical_Model_Data(SSI, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test020/CORE_ExampleCarlson", "WO")
...
evaluate(maincurves0, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test020/CORE_ExampleCarlson", "WO",labelfig="Primary drainage")
evaluate(maincurves1, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test020/CORE_ExampleCarlson", "WO",labelfig="First imbibition")

evaluate(SatSpace, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-B/test020/CORE_ExampleCarlson", "WO",labelfig="Imbib. Carlson scan curve")
