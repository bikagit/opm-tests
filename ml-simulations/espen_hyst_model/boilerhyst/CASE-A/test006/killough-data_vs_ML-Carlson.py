...
newtrain_file = '/../../../../../spe1/swat_oilkr3caseA.csv'

train_file = '/../../data/curated_data/KrPcData_Combinedtot.csv'

krnw, krw, SandSmax = PreprocessData(SSI, train_file, "GW")

newkrnw, newkrw, newSandSmax = newPreprocessData(SSI, newtrain_file,"/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleKillough", "WO")


original_krnw, original_krw, original_SandSmax = PreprocessData(SSI, '/../../data/curated_data/KrPcData_Swi0_06-CORR-OCT2025.csv', "GW")

krnw_modl, krw_modl, SandSmax_modl = Preprocess_analytical_Model_Data(SSI, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleCarlson", "WO")
...
evaluate(maincurves0, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleCarlson", "WO",labelfig="Primary drainage")
evaluate(maincurves1, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleCarlson", "WO",labelfig="First imbibition")

evaluate(SatSpace, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleCarlson", "WO",labelfig="Imbib. Carlson scan curve")
