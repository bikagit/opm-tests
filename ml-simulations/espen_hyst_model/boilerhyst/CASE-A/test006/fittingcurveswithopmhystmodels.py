...
def trainNN(krnw, Smax):
    ...
    early_stopping = EarlyStopping(monitor='val_loss', patience=20, restore_best_weights=True, start_from_epoch=500)
...
maincurves2.append(np.linspace(0.2067,0.78,3000))

maincurves3.append(np.linspace(0.4019,0.78,3000))

# maincurves4.append(np.linspace(0.6013,0.78,3000))
...
evaluate(maincurves0, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleKillough", "WO",labelfig="Main drainage")
evaluate(maincurves1, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleKillough", "WO",labelfig="Main imbibition")
# evaluate(maincurves2, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CORE_Example", "WO")
# evaluate(maincurves2, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleKillough", "WO",labelfig="Sec. Imbib. Killough ($S_w=0.2$)")
# evaluate(maincurves3, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleKillough", "WO",labelfig="Sec. Imbib. Killough ($S_w=0.4$)")
# evaluate(maincurves4, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleKillough", "WO",labelfig="Imbibition Killough scan curve")
...
evaluate(maincurves2, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleCarlson", "WO",labelfig="Sec. Imbib. Carlson ($S_w=0.2$)")
evaluate(maincurves3, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleCarlson", "WO",labelfig="Sec. Imbib. Carlson ($S_w=0.4$)")
# evaluate(maincurves4, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CASE-A/test006/CORE_ExampleCarlson", "WO",labelfig="Imbibition Carlson scan curve")
...
for i, (start, end) in enumerate(index_ranges_imbib):
    plt.scatter(1-original_x[start:end, 0], original_y[start:end], alpha=0.6, color='olive', marker=".", label='LS-LBM Sec. Imbib. ($S_w=0.2$)' if i == 0 else "")
    plt.scatter(1-x[start:end, 0], y_pred_all[start:end], alpha=0.6, color='darkgreen', marker="*", label='ML-LS-LBM Sec. Imbib. ($S_w=0.2$)' if i == 0 else "")
    # plt.scatter(x_val[start:end, 0], y_pred_val[start:end], alpha=0.6, color='red', label='Original Imbib' if i == 0 else "")


for i, (start, end) in enumerate(index_ranges_imbibis):
    plt.scatter(1-original_x[start:end, 0], original_y[start:end], alpha=0.6, color='pink', marker=".", label='LS-LBM Sec. Imbib. ($S_w=0.4$)' if i == 0 else "")
    plt.scatter(1-x[start:end, 0], y_pred_all[start:end], alpha=0.6, color='purple', marker="*", label='ML-LS-LBM Sec. Imbib. ($S_w=0.4$)' if i == 0 else "")
    # plt.scatter(x_val[start:end, 0], y_pred_val[start:end], alpha=0.6, color='red', label='Original Imbib' if i == 0 else "")
