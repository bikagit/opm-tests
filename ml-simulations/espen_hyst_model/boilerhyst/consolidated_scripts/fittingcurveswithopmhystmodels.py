...
# maincurves2.append(np.linspace(0.78,0.08,30))
# maincurves3.append(np.linspace(0.95,0.0,60))
# maincurves3.append(np.linspace(0.0,0.95,60))
...
evaluate(maincurves0, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/SPE1CASE2_2P-1D-OILINJMULTI", "WO",labelfig="Primary drainage")
evaluate(maincurves1, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/SPE1CASE2_2P-1D-OILINJMULTI", "WO",labelfig="First imbibition")
# evaluate(maincurves2, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/SPE1CASE2_2P-1D-OILINJMULTI", "WO")
evaluate(maincurves3, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/SPE1CASE2_2P-1D-OILINJMULTI", "WO",labelfig="Imbibition Killough scan curve")
evaluate(maincurves4, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/SPE1CASE2_2P-1D-OILINJMULTI", "WO",labelfig="Imbibition Killough scan curve")
...
for i, (start, end) in enumerate(index_ranges_imbib):
    plt.scatter(original_x[start:end, 0], original_y[start:end], alpha=0.6, color='cyan', marker="*", label='Original Imbib. scan curves' if i == 0 else "")
    plt.scatter(x[start:end, 0], y_pred_all[start:end], alpha=0.6, color='black', marker="*", label='DNN Imbib. scan curves' if i == 0 else "")
