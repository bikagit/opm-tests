...
def trainNN(krnw, Smax):
    ...
    # neurons = [24] * layers  # 4 neurons per layer
    layers = 10  # Number of hidden layers
...
krnw, krw, SandSmax = PreprocessData(SS, '/data/KrPcData_Combined065.csv', "GW")
...
krnw_val, krw_val, SandSmax_val = PreprocessData(SS, '/data/KrPcData_Swi0_20.csv', "GW")
