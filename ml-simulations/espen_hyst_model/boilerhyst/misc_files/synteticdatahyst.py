...
# Paths to data
train_file = 'data/arkivdata/KrPcData_CombinedTOT.csv'
val_file =  'data/arkivdata/KrPcData_Swi0_06-CORRECTED.csv'
...
# Train model
model, history, X_test, y_test = trainNN(x_train, y_train)
...
plt.xlabel('$S_w$'); plt.ylabel('$k_{rn}$'); plt.grid(True)
