...
krnw_modl, krw_modl, SandSmax_modl = Preprocess_analytical_Model_Data(SSI, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CORE_ExampleCarlson", "WO")
...
for valsatmax in {0.25,0.3,0.35, 0.4, 0.5}:
    ...
    if x_vals and y_vals:
        plt.plot(x_vals, y_vals, color='black', marker="*", label="DNN Imbib. scan curves" if valsatmax == 0.25 else "")
...
evaluate(maincurves0, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CORE_ExampleCarlson", "WO",labelfig="Primary drainage")
evaluate(maincurves1, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CORE_ExampleCarlson", "WO",labelfig="First imbibition")

evaluate(SatSpace, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/CORE_ExampleCarlson", "WO",labelfig="Imbib. Carlson scan curve")
