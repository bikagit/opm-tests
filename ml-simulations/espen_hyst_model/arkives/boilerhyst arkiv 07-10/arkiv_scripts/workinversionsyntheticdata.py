...
def trainNN(krnw, Smax):
    ...
    synthetic_x, synthetic_y = generate_synthetic_data(x, y, num_samples=len(x) * 15)
    ...
    neurons = [4] * layers  # 4 neurons per layer
...
export_model(modelnonwett, 'model/bloboldmodelkrnw.model')
