...
krnw, krw, SandSmax = PreprocessData(SS, '/data/arkivdata/KrPcData_Combined035.csv', "WO")

orikrnw, orikrw, oriSandSmax = PreprocessData(SS, '/data/arkivdata/KrPcData_Swi0_35.csv', "WO")
orikrnw1, orikrw1, oriSandSmax1 = PreprocessData(SS, '/data/arkivdata/KrPcData_Swi0_06-CORRECTED.csv', "WO")
