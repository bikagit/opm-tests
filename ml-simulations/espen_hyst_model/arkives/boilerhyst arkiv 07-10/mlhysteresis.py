...
class CustomEnv:
    ...
    def preprocess_data(self):
        ...
        pathCall = f"/Users/macbookn/activopmwkspc/edgedev/build/opm-common/bin/hysteresis {self.data}.DATA data/sat.csv data/relperms.csv {self.wp} 0"
        os.system(pathCall)
...
env = CustomEnv(SS, "/Users/macbookn/activopmwkspc/edgedev/opm-tests/spe1/SPE1CASE2_2P", "WO")
