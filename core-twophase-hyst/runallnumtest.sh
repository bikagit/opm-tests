...
generate_plots Killough $FOLDER/Figures/KilloughFiguresOutput "g,y,k" "ML-Killough-hyst  Killough hyst  No-hyst" \
"$FOLDER/Killoughmlhystnew-output/CORE_EXAMPLEKILLOUGH $FOLDER/ClassicKillough-hystnew-output/CORE_EXAMPLEKILLOUGH $FOLDER/Nohysteresis-output/CORE_EXAMPLENOHYST" d curvekillough 9 10
...
generate_plots LSLBM $FOLDER/Figures/LSLBMFiguresOutput "b,g,r" "ML-Carlson-hyst  ML-Killough-hyst  ML-LS-LBM" \
"$FOLDER/Carlsonmlhystnew-output/CORE_EXAMPLECARLSON $FOLDER/Killoughmlhystnew-output/CORE_EXAMPLEKILLOUGH $FOLDER/LSLBMmlhystnew-output/CORE_EXAMPLE" d curvelslbm 9 10
...
for cell in $(seq 1 9); do
    ...
    -labels "ML-Carlson-hyst  ML-Killough-hyst  ML-LS-LBM  No-hyst" \
...
#     #     --outdir "$FOLDER/Figures/my_plotskillough"
    ...
    #     --csv-names $MODELFOLDER/runNohystLS.csv $MODELFOLDER/runLSMLKILLOUGH.csv $MODELFOLDER/runLSMLCARLSON.csv $MODELFOLDER/runMLLSLBM.csv \
    #     --legends "Nohyst" "Killough" "Carlson" "LSLBM" \
    #     --outdir "$FOLDER/Figures/my_plotslslbm"\
    #     --model-colors black green blue orange \
    #     --dates "05.jan 2015" '06.JAN 2015' '07.JAN 2015'        # --cells "$cell" 1 1 
    #     # --cells "$cell" 1 1 
